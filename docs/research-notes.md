...
- CI runs type-check, tests, package dry-run, package contents gating, CycloneDX SBOM generation, self-indexing, and architecture output; separate workflows cover OpenSSF Scorecard and release build-provenance attestations.
