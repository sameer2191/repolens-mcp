...
- A repeatable benchmark run on the large validation repo completed a full index in 14,919 ms and a no-op incremental index in 101 ms while preserving a 5,826-symbol, 38,995-edge graph with 153 Next.js route nodes, 653 resolved import edges, 5,974 type-use edges, 983 data-flow edges, and 387 locked dependencies.
