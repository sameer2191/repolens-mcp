...
- The package contents gate blocks local graph memory, SQLite databases, graph packages, tests, source TypeScript, private validation output, and local workstation paths from the published npm artifact.
