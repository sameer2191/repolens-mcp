...
- Node test suite passed: 46 tests, 45 passing, 0 failures, 1 sandbox-only dashboard socket skip.
...
- Packed artifact: `repolens-mcp-1.0.0.tgz`, 156,246 bytes packed, 824,910 bytes unpacked, 71 runtime entries.
